...
<div class="legal-document">
    ...
    <div class="legal-content">
        ...
        <section>
            ...
            <ul>
                <li>Some website builds may require a 30–50% deposit</li>
        ...
        <section>
            <h2>4. One-Time Services ($20–$75+)</h2>
        ...
        <section>
            ...
            <p>✔ Full refund (minus 10% administrative fee)</p>
            
            <h3>After work begins:</h3>
            <ul>
                <li>✔ Refunds are not available</li>
                <li>✔ You will be responsible for work already completed</li>
                <li>✔ Any purchased tools, licenses, or materials are non-refundable</li>
            </ul>
